                      ...
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <form id="adMemberForm">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control add-member" id="company" placeholder="Department name" name="Department">
                          </div>
                        </div>
                         <div class="col-md-6 col-md-6">
                          <div class="form-group">
                            <label for="contact">Designation* :</label>
                            <input type="text" class="form-control add-member" id="Designation" placeholder="Designation" name="Designation">
                          </div>
                        </div>
                        <div class="col-md-6 col-md-6">
                          <div class="form-group">
                            <label for="email">Contact*:</label>
                            <input type="contact" class="form-control add-member" id="contact" placeholder="contact" name="contact">
                          </div>
                        </div>
                          <div class="col-md-6 col-lg-6">
                          <div class="form-group">
                          <label for="email">Email*:</label>
                          <input type="email" class="form-control add member" name="email" id="email" placeholder="email" >
                         </div>
                       </div>
                       <div class="col-md-6 col-md-6">
                          <div class="form-group">
