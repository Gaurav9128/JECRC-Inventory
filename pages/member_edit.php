           ...
           $data = $obj->find('member' , 'id' , $edit_id);
            ...
            <form id="editMemberForm">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control add-member" id="department" name="department" value="<?=$data->department;?>">
              </div>
              <div class="form-group">
                <label for="designation">Designation *:</label>
                <input type="text" class="form-control add-member" id="designation" name="designation" value="<?=$data->designation;?>">
              </div>
              <div class="form-group">
